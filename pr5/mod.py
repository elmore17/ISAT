...
class LiquidDistributionEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # определяется как минимум между количеством жидкости в стакане-источнике и количеством жидкости, которое можно добавить в стакан-назначение, чтобы достичь среднего значения всех стаканов
        from_idx = action[0]
        to_idx = action[1]
